...
import (
	...
	"filesafe"
	"filesafe_internal_api"
)

var _ = filesafe.GoUnusedProtection__
var _ = filesafe_internal_api.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  SearchFileRes search_file(SearchFileReq req)")
  fmt.Fprintln(os.Stderr, "  CheckFileRes check_file(CheckFileReq req)")
  fmt.Fprintln(os.Stderr, "  AddFileRes upload_file(AddFileReq req)")
  fmt.Fprintln(os.Stderr, "  MoveFileRes move_file(MoveFileReq req)")
  fmt.Fprintln(os.Stderr, "  DeleteFileRes delete_file(DeleteFileReq req)")
  fmt.Fprintln(os.Stderr, "  RecoveryFileRes recover_file(RecoveryFileReq req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := filesafe_internal_api.NewInternalServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "search_file":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "SearchFile requires 1 args")
      flag.Usage()
    }
    arg14 := flag.Arg(1)
    ...
    argvalue0 := filesafe_internal_api.NewSearchFileReq()
    ...
    value0 := argvalue0
    fmt.Print(client.SearchFile(context.Background(), value0))
    fmt.Print("\n")
    break
  case "check_file":
    if flag.NArg() - 1 != 1 {
    ...
    argvalue0 := filesafe_internal_api.NewCheckFileReq()
    ...
    value0 := argvalue0
    fmt.Print(client.CheckFile(context.Background(), value0))
    fmt.Print("\n")
    break
  case "upload_file":
    if flag.NArg() - 1 != 1 {
    ...
    argvalue0 := filesafe_internal_api.NewAddFileReq()
  ...
  case "move_file":
    ...
    argvalue0 := filesafe_internal_api.NewMoveFileReq()
  ...
  case "delete_file":
    ...
    argvalue0 := filesafe_internal_api.NewDeleteFileReq()
  ...
  case "recover_file":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "RecoverFile requires 1 args")
      flag.Usage()
    }
    arg44 := flag.Arg(1)
    ...
    argvalue0 := filesafe_internal_api.NewRecoveryFileReq()
    ...
    value0 := argvalue0
    fmt.Print(client.RecoverFile(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
