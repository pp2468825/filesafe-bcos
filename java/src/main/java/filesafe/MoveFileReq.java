...
public class MoveFileReq implements org.apache.thrift.TBase<MoveFileReq, MoveFileReq._Fields>, java.io.Serializable, Cloneable, Comparable<MoveFileReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MoveFileReq");
  ...
  private static final org.apache.thrift.protocol.TField TARGET_PATH_FIELD_DESC = new org.apache.thrift.protocol.TField("target_path", org.apache.thrift.protocol.TType.STRING, (short)20);
  private static final org.apache.thrift.protocol.TField DIGEST_FIELD_DESC = new org.apache.thrift.protocol.TField("digest", org.apache.thrift.protocol.TType.STRING, (short)30);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new MoveFileReqStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new MoveFileReqTupleSchemeFactory();
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String target_path; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    TARGET_PATH((short)20, "target_path"),
    DIGEST((short)30, "digest");
  ...
  static {
    ...
    tmpMap.put(_Fields.FILE_PATH, new org.apache.thrift.meta_data.FieldMetaData("file_path", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.TARGET_PATH, new org.apache.thrift.meta_data.FieldMetaData("target_path", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MoveFileReq.class, metaDataMap);
  }
   ...
   */
  public MoveFileReq(MoveFileReq other) {
  ...
  public MoveFileReq setUser_id(@org.apache.thrift.annotation.Nullable java.lang.String user_id) {
    this.user_id = user_id;
    return this;
  }
  ...
  public MoveFileReq setFile_path(@org.apache.thrift.annotation.Nullable java.lang.String file_path) {
    this.file_path = file_path;
    return this;
  }
  ...
  public MoveFileReq setTarget_path(@org.apache.thrift.annotation.Nullable java.lang.String target_path) {
    this.target_path = target_path;
    return this;
  }

  public void unsetTarget_path() {
    this.target_path = null;
  }

  /** Returns true if field target_path is set (has been assigned a value) and false otherwise */
  public boolean isSetTarget_path() {
    return this.target_path != null;
  }

  public void setTarget_pathIsSet(boolean value) {
    if (!value) {
      this.target_path = null;
    }
  }
  ...
  public MoveFileReq setDigest(@org.apache.thrift.annotation.Nullable java.lang.String digest) {
    this.digest = digest;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case TARGET_PATH:
      if (value == null) {
        ...
        setTarget_path((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof MoveFileReq)
      return this.equals((MoveFileReq)that);
    return false;
  }

  public boolean equals(MoveFileReq that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_target_path = true && this.isSetTarget_path();
    boolean that_present_target_path = true && that.isSetTarget_path();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetTarget_path()) ? 131071 : 524287);
    if (isSetTarget_path())
  ...
  @Override
  public int compareTo(MoveFileReq other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetTarget_path(), other.isSetTarget_path());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTarget_path()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("MoveFileReq(");
    boolean first = true;
  ...
  private static class MoveFileReqStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MoveFileReqStandardScheme getScheme() {
      return new MoveFileReqStandardScheme();
    }
  }

  private static class MoveFileReqStandardScheme extends org.apache.thrift.scheme.StandardScheme<MoveFileReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MoveFileReq struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 20: // TARGET_PATH
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              ...
              struct.setTarget_pathIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MoveFileReq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MoveFileReqTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MoveFileReqTupleScheme getScheme() {
      return new MoveFileReqTupleScheme();
    }
  }

  private static class MoveFileReqTupleScheme extends org.apache.thrift.scheme.TupleScheme<MoveFileReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MoveFileReq struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MoveFileReq struct) throws org.apache.thrift.TException {
