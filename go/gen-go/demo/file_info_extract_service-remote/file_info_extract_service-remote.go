...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  FileDataRsp uploadFile(FileDataReq filedata)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := demo.NewFileInfoExtractServiceClient(thrift.NewTStandardClient(iprot, oprot))
