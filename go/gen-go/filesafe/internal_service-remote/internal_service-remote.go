...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  AddFileRes add_file(AddFileReq req)")
...
func main() {
  ...
  client := filesafe.NewInternalServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "search_file":
    ...
    argvalue0 := filesafe.NewSearchFileReq()
  ...
  case "check_file":
    ...
    argvalue0 := filesafe.NewCheckFileReq()
  ...
  case "add_file":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "AddFile requires 1 args")
      flag.Usage()
    }
    arg26 := flag.Arg(1)
    ...
    argvalue0 := filesafe.NewAddFileReq()
    ...
    value0 := argvalue0
    fmt.Print(client.AddFile(context.Background(), value0))
    fmt.Print("\n")
    break
  case "move_file":
    if flag.NArg() - 1 != 1 {
    ...
    argvalue0 := filesafe.NewMoveFileReq()
  ...
  case "delete_file":
    ...
    argvalue0 := filesafe.NewDeleteFileReq()
  ...
  case "recover_file":
    ...
    argvalue0 := filesafe.NewRecoveryFileReq()
