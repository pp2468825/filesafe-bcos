...
func addFile(ctx context.Context, ipfs icore.CoreAPI, inputPath string) {
...
func addDirectory(ctx context.Context, ipfs icore.CoreAPI, dirPath string) {
	someDirectory, err := getUnixfsNode(dirPath)
	if err != nil {
		panic(fmt.Errorf("Could not get File: %s", err))
	}
...
func getFile(ctx context.Context, ipfs icore.CoreAPI, cidFile icorepath.Resolved, outputPath string) {
	outputPathFile := outputPath + strings.Split(cidFile.String(), "/")[2]
...
func getDirectory(ctx context.Context, ipfs icore.CoreAPI, cidDirectory icorepath.Resolved, outputPath string) {
	outputPathDirectory := outputPath + strings.Split(cidDirectory.String(), "/")[2]
...
func FetchFileFromNetwork(ctx context.Context, ipfs icore.CoreAPI, cid string, outputBasePath string) {
